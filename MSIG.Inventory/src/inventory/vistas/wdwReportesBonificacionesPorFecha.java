...
public class wdwReportesBonificacionesPorFecha extends javax.swing.JInternalFrame {
     ...
     */
    public wdwReportesBonificacionesPorFecha() {
        initComponents();
        cargaEmpleados();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Bonificaciones por Fecha");
        ...
        cbxPuesto.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Propietario", "Gerente", "Administrador", "Jefe Sucursal", "Secretaria", "Cajero", "Tecnico", "Vendedor" }));

        jLabel2.setText("Puesto");

        jLabel3.setText("Tipo");

        cbxTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cantidad Vendida", "Precio de Venta" }));
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        try {
            ...
            if ( cbxPuesto.getSelectedItem().toString().equals("Tecnico") && cbxTipo.getSelectedItem().toString().equals("Cantidad Vendida")) {
                nombre_reporte = "rptBonificacionPorCantidad";
            }
            
            if ( cbxPuesto.getSelectedItem().toString().equals("Tecnico") && cbxTipo.getSelectedItem().toString().equals("Precio de Venta")) {
                nombre_reporte = "rptBonificacionPorPrecio";
            }
            
            if ( !cbxPuesto.getSelectedItem().toString().equals("Tecnico") && cbxTipo.getSelectedItem().toString().equals("Cantidad Vendida")) {
                nombre_reporte = "rptBonificacionPorCantidadTodos";
            }
            
            if ( !cbxPuesto.getSelectedItem().toString().equals("Tecnico") && cbxTipo.getSelectedItem().toString().equals("Precio de Venta")) {
                nombre_reporte = "rptBonificacionPorPrecioTodos";
            }
            ...
            parametro.put("P_TIPO", cbxPuesto.getSelectedItem().toString());
            parametro.put("P_EMPLEADO", cbxEmpleado.getSelectedItem().toString());
            ...
            Mensaje.manipulacionExcepciones("critico", error.getMessage(), "Reporte Bonificaciones por Fecha");
        }
