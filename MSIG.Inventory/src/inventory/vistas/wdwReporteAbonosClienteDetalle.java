       ...
       AccesoExcepciones Mensaje = new AccesoExcepciones();
        ...
        try {
            ...
            if (txtNit.getText().isEmpty()) {
                parametro.put("P_NIT_PERSONA", null);
                informacion = "Todos";
            } else {
               parametro.put("P_NIT_PERSONA", txtNit.getText()); 
               informacion = txtNit.getText();
            }
            ...
            parametro.put("P_INFORMACION", "NIT: " + informacion + "   Periodo Del " + ConvertirFecha(txtFechaInicial) + " al " + ConvertirFecha(txtFechaFinal));
            ...
            Mensaje.manipulacionExcepciones("critico", error.getMessage(), "Reporte Abono por Cliente");
        }
