...
public class wdwReportesPorLinea extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Existencia por Linea");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        try {
            ...
            if (cbxCategoria.getSelectedItem().toString().isEmpty()) {
                parametro.put("P_LINEA", "%%");
            } else {
               parametro.put("P_LINEA", "%" + cbxCategoria.getSelectedItem().toString() + "%"); 
            }
            ...
            parametro.put("P_INFORMACION", cbxCategoria.getSelectedItem().toString().toUpperCase());
