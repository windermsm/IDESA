...
public class wdwReportesTrazabilidadSerie extends javax.swing.JInternalFrame {

    /**
     * Creates new form wdwReportesInventarioImpreso
     */
    public wdwReportesTrazabilidadSerie() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Trazabilidad Serie");
        ...
        lblIdProveedor.setText("Numero Serie");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        try {
            ...
            URL url_reporte = this.getClass().getResource("/inventory/reportes/rptTrazabilidadSerie.jasper");
            JasperReport reporte = (JasperReport) JRLoader.loadObject(url_reporte);
            //ENVIAR EL PARAMETRO AL REPORTES
            HashMap parametro = new HashMap();
            parametro.put("P_SERIE", txtSerie.getText().replaceAll("'", "´").trim()); 
            ...
            parametro.put("P_INFORMACION", txtSerie.getText());
