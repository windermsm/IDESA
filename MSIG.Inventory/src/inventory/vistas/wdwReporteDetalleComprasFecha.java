...
public class wdwReporteDetalleComprasFecha extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        chkPagos.setText("Mostrar Pagos Realizados");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        String nombre_reporte = "rptDetalleCompra";
        
        if(chkPagos.isSelected()) {
            nombre_reporte = "rptDetalleCompraConPagos";
        }
        ...
        try {
            ...
            Mensaje.manipulacionExcepciones("critico", error.getMessage(), "Reporte Detalle de Compras por Fecha");
        }
