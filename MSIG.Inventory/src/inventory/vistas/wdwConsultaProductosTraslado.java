    ...
    private void initComponents() {
        ...
        pnlBotonesLayout.setHorizontalGroup(
            ...
            .addGroup(pnlBotonesLayout.createSequentialGroup()
                ...
                .addComponent(txtBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 247, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            ...
            try {
                ...
                Mensaje.manipulacionExcepciones("critico", Error.toString(), "Total de Productos");
            }
    ...
    private void buscarEnRegistrosGuardados(){
        ...
        if(busqueda != null){
            ...
            try{
                ...
                Mensaje.manipulacionExcepciones("critico", Error.getMessage(), "Listar Productos Guardados");
            }

            //MOSTRAR LA INFORMACION DE LOS PRODUCTOS EN LA TABLA DE LA VISTA
            if(listaProductos.isEmpty()){
                Mensaje.manipulacionExcepciones("critico", "No existen datos almacenados de productos", "Mostrar Producto");
            } else {
