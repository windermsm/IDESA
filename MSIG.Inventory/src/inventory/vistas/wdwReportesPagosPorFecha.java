...
public class wdwReportesPagosPorFecha extends javax.swing.JInternalFrame {
     ...
     */
    public wdwReportesPagosPorFecha() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Gastos por Fecha");
        ...
        lblFechaInicial.setText("Fecha Incial");
        ...
        lblFechaInicial1.setText("Fecha Final");

        cbxCuenta.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todas", "Alquiler", "Aranceles", "Electricidad", "Equipo de Computo", "Gasolina", "Internet", "Impuestos", "Otros", "Proveedores", "Papeleria y Utiles", "Rembolso", "Repuestos", "Servicio Tecnico", "Servicio Profecional", "Suministros", "Taller", "Telefonia", "Transporte", "Viaticos" }));
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try {
            ...
            URL url_reporte = this.getClass().getResource("/inventory/reportes/rptPagosResumen.jasper");
            ...
            parametro.put("P_CUENTA", cbxCuenta.getSelectedItem().toString());
            ...
            mensaje.manipulacionExcepciones("critico", error.getMessage(), "Reporte PAGOS RESUMEN");
        }
