...
public class wdwReportesDetalleAbonosProveedor extends javax.swing.JInternalFrame {

    /**
     * Creates new form wdwReportesVentasPorFecha
     */
    public wdwReportesDetalleAbonosProveedor() {
        initComponents();
        MostarProveedores();
    }
    
    public void MostarProveedores() {
        cbxNombreProveedor.removeAllItems();
        AccesoProveedor acceso_proveedor = new AccesoProveedor();
        ArrayList<ObjetosPersona> lista_nombres = new ArrayList<>();
        lista_nombres = acceso_proveedor.listarNombreDeProveedores(Inventory.lblUsuario.getText(), Inventory.lblTerminal.getText());
        Iterator iterador = lista_nombres.iterator();
        while(iterador.hasNext()) {
           ObjetosPersona persona = (ObjetosPersona) iterador.next();
           cbxNombreProveedor.addItem(persona.getNom_persona());
        }
    }
    ...
    private void initComponents() {
        ...
        cbxNombreProveedor = new javax.swing.JComboBox<>();
        ...
        lblTitulo.setText("Detalle de Abonos a Proveedor");
        ...
        cbxNombreProveedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxNombreProveedorActionPerformed(evt);
            }
        });
                ...
                .addGroup(pnlParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlParametrosLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtFechaFinal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtNitCliente)
                            .addComponent(cbxNombreProveedor, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        pnlParametrosLayout.setVerticalGroup(
            ...
            .addGroup(pnlParametrosLayout.createSequentialGroup()
                ...
                .addGroup(pnlParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbxNombreProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addGap(18, 18, 18)
                .addGroup(pnlParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
       ...
       AccesoExcepciones Mensaje = new AccesoExcepciones();
        ...
        try {
            ...
            URL url_reporte = this.getClass().getResource("/inventory/reportes/rptDetalleAbonosProveedor.jasper");
            ...
            if (txtNitCliente.getText().isEmpty()) {
               ...
               parametro.put("P_NIT", txtNitCliente.getText().trim()); 
            }
            ...
            Mensaje.manipulacionExcepciones("critico", error.getMessage(), "Reporte COMPRAS POR FECHA");
        }
    }//GEN-LAST:event_btnGenerarReporteActionPerformed

    private void cbxNombreProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxNombreProveedorActionPerformed
        AccesoPersona acceso_persona = new AccesoPersona();
        ArrayList<ObjetosPersona> lista_personas = new ArrayList<>();
        lista_personas = acceso_persona.buscarPersonaPorNombre(cbxNombreProveedor.getSelectedItem().toString(), Inventory.lblUsuario.getText(), Inventory.lblTerminal.getText());
        Iterator iterador = lista_personas.iterator();
        while(iterador.hasNext()) {
            ObjetosPersona persona = (ObjetosPersona) iterador.next();
            txtNitCliente.setText(persona.getNit_persona());
        }
    }//GEN-LAST:event_cbxNombreProveedorActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnGenerarReporte;
    private javax.swing.JComboBox<String> cbxNombreProveedor;
