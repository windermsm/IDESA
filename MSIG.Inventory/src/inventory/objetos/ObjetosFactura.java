...
public class ObjetosFactura {
    ...
    private String cajero_factura;
    private String nombre_factura;
    private String pos_factura;
    private String fecha_cancelacion_factura;
    ...
    public String getCajero_factura() {
        return cajero_factura;
    }

    public void setCajero_factura(String cajero_factura) {
        this.cajero_factura = cajero_factura;
    }
    ...
    public String getPos_factura() {
        return pos_factura;
    }

    public void setPos_factura(String pos_factura) {
        this.pos_factura = pos_factura;
    }

    public String getFecha_cancelacion_factura() {
        return fecha_cancelacion_factura;
    }

    public void setFecha_cancelacion_factura(String fecha_cancelacion_factura) {
        this.fecha_cancelacion_factura = fecha_cancelacion_factura;
    }
